%Fourth submission Sci Rep 4 September 2017
...
We perform network connectivity in iEEG and we find that phase-based connectivity is sensitive to transition from eyes closed to eyes open only in interhemispheral and frontal electrodes. Power based connectivity, on the other hand, consistently discriminates between the two conditions in temporal and interhemispheral electrodes. 
...
We find that the wiring cost variation from eyes closed to eyes open is sensitive to eyes closed and eyes open conditions. We extend the standard network-based approach using a filtration method that does not rely on threshold selection problem.
...
%A wavelet is in essence a convolution kernel used to determine to what extend the signal contains features that are similar to the properties of the wavelet. If the wavelet convolution is repeatidly used on the same data for different frequencies we obtain a time-frequency representation.
...
\begin{figure}[H]
        \centering
        %angle=-90,
        \includegraphics[origin=c, width=1\linewidth]{networksec-eoRot2}
...
\begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth]{networkmetrics_power2}
        \vspace{-1em}
...
\bibitem{biswal_functional_1995}
...
\bibitem{papo2013should}
\bibinfo{author}{Papo, D.}
\newblock \bibinfo{title}{Why should cognitive neuroscientists study the
  brain's resting state?}
\newblock \emph{\bibinfo{journal}{Frontiers in human neuroscience}}
  \textbf{\bibinfo{volume}{7}}, \bibinfo{pages}{45} (\bibinfo{year}{2013}).

\bibitem{buckner2007unrest}
\bibinfo{author}{Buckner, R.~L.} \& \bibinfo{author}{Vincent, J.~L.}
\newblock \bibinfo{title}{Unrest at rest: default activity and spontaneous
  network correlations}.
\newblock \emph{\bibinfo{journal}{Neuroimage}} \textbf{\bibinfo{volume}{37}},
  \bibinfo{pages}{1091--1096} (\bibinfo{year}{2007}).

\bibitem{morcom2007does}
\bibinfo{author}{Morcom, A.~M.} \& \bibinfo{author}{Fletcher, P.~C.}
\newblock \bibinfo{title}{Does the brain have a baseline? why we should be
  resisting a rest}.
\newblock \emph{\bibinfo{journal}{Neuroimage}} \textbf{\bibinfo{volume}{37}},
  \bibinfo{pages}{1073--1082} (\bibinfo{year}{2007}).

\bibitem{wang2006changes}
\bibinfo{author}{Wang, L.} \emph{et~al.}
\newblock \bibinfo{title}{Changes in hippocampal connectivity in the early
  stages of alzheimer's disease: evidence from resting state fmri}.
\newblock \emph{\bibinfo{journal}{Neuroimage}} \textbf{\bibinfo{volume}{31}},
  \bibinfo{pages}{496--504} (\bibinfo{year}{2006}).

\bibitem{mantini2007electrophysiological}
\bibinfo{author}{Mantini, D.}, \bibinfo{author}{Perrucci, M.~G.},
  \bibinfo{author}{Del~Gratta, C.}, \bibinfo{author}{Romani, G.~L.} \&
  \bibinfo{author}{Corbetta, M.}
\newblock \bibinfo{title}{Electrophysiological signatures of resting state
  networks in the human brain}.
\newblock \emph{\bibinfo{journal}{Proceedings of the National Academy of
  Sciences}} \textbf{\bibinfo{volume}{104}}, \bibinfo{pages}{13170--13175}
  (\bibinfo{year}{2007}).

\bibitem{tracy2015resting}
\bibinfo{author}{Tracy, J.~I.} \& \bibinfo{author}{Doucet, G.~E.}
\newblock \bibinfo{title}{Resting-state functional connectivity in epilepsy:
  growing relevance for clinical decision making}.
\newblock \emph{\bibinfo{journal}{Current opinion in neurology}}
  \textbf{\bibinfo{volume}{28}}, \bibinfo{pages}{158--165}
  (\bibinfo{year}{2015}).

\bibitem{sokoloff1955effect}
\bibinfo{author}{Sokoloff, L.}, \bibinfo{author}{Mangold, R.},
  \bibinfo{author}{Wechsler, R.~L.}, \bibinfo{author}{Kennedy, C.} \&
  \bibinfo{author}{Kety, S.~S.}
\newblock \bibinfo{title}{The effect of mental arithmetic on cerebral
  circulation and metabolism}.
\newblock \emph{\bibinfo{journal}{Journal of Clinical Investigation}}
  \textbf{\bibinfo{volume}{34}}, \bibinfo{pages}{1101} (\bibinfo{year}{1955}).

\bibitem{van2010exploring}
\bibinfo{author}{Van Den~Heuvel, M.~P.} \& \bibinfo{author}{Pol, H. E.~H.}
\newblock \bibinfo{title}{Exploring the brain network: a review on
  resting-state fmri functional connectivity}.
\newblock \emph{\bibinfo{journal}{European Neuropsychopharmacology}}
  \textbf{\bibinfo{volume}{20}}, \bibinfo{pages}{519--534}
  (\bibinfo{year}{2010}).

\bibitem{musso2010spontaneous}
\bibinfo{author}{Musso, F.}, \bibinfo{author}{Brinkmeyer, J.},
  \bibinfo{author}{Mobascher, A.}, \bibinfo{author}{Warbrick, T.} \&
  \bibinfo{author}{Winterer, G.}
\newblock \bibinfo{title}{Spontaneous brain activity and eeg microstates. a
  novel eeg/fmri analysis approach to explore resting-state networks}.
\newblock \emph{\bibinfo{journal}{Neuroimage}} \textbf{\bibinfo{volume}{52}},
  \bibinfo{pages}{1149--1161} (\bibinfo{year}{2010}).

\bibitem{patriat2013effect}
\bibinfo{author}{Patriat, R.} \emph{et~al.}
\newblock \bibinfo{title}{The effect of resting condition on resting-state fmri
  reliability and consistency: a comparison between resting with eyes open,
  closed, and fixated}.
\newblock \emph{\bibinfo{journal}{Neuroimage}} \textbf{\bibinfo{volume}{78}},
  \bibinfo{pages}{463--473} (\bibinfo{year}{2013}).

\bibitem{yan2009spontaneous}
\bibinfo{author}{Yan, C.} \emph{et~al.}
\newblock \bibinfo{title}{Spontaneous brain activity in the default mode
  network is sensitive to different resting-state conditions with limited
  cognitive load}.
\newblock \emph{\bibinfo{journal}{PloS one}} \textbf{\bibinfo{volume}{4}},
  \bibinfo{pages}{e5743} (\bibinfo{year}{2009}).

\bibitem{tan2013difference}
\bibinfo{author}{Tan, B.}, \bibinfo{author}{Kong, X.}, \bibinfo{author}{Yang,
  P.}, \bibinfo{author}{Jin, Z.} \& \bibinfo{author}{Li, L.}
\newblock \bibinfo{title}{The difference of brain functional connectivity
  between eyes-closed and eyes-open using graph theoretical analysis}.
\newblock \emph{\bibinfo{journal}{Computational and mathematical methods in
  medicine}} \textbf{\bibinfo{volume}{2013}} (\bibinfo{year}{2013}).

\bibitem{barry2007eeg}
\bibinfo{author}{Barry, R.~J.}, \bibinfo{author}{Clarke, A.~R.},
  \bibinfo{author}{Johnstone, S.~J.}, \bibinfo{author}{Magee, C.~A.} \&
  \bibinfo{author}{Rushby, J.~A.}
\newblock \bibinfo{title}{Eeg differences between eyes-closed and eyes-open
  resting conditions}.
\newblock \emph{\bibinfo{journal}{Clinical Neurophysiology}}
  \textbf{\bibinfo{volume}{118}}, \bibinfo{pages}{2765--2773}
  (\bibinfo{year}{2007}).

\bibitem{niedermeyer2005electroencephalography}
\bibinfo{author}{Niedermeyer, E.} \& \bibinfo{author}{da~Silva, F.~L.}
\newblock \emph{\bibinfo{title}{Electroencephalography: basic principles,
  clinical applications, and related fields}} (\bibinfo{publisher}{Lippincott
  Williams \& Wilkins}, \bibinfo{year}{2005}).

\bibitem{geller2014eye}
\bibinfo{author}{Geller, A.~S.} \emph{et~al.}
\newblock \bibinfo{title}{Eye closure causes widespread low-frequency power
  increase and focal gamma attenuation in the human electrocorticogram}.
\newblock \emph{\bibinfo{journal}{Clinical Neurophysiology}}
  \textbf{\bibinfo{volume}{125}}, \bibinfo{pages}{1764--1773}
  (\bibinfo{year}{2014}).

\bibitem{freeman2009simulated}
\bibinfo{author}{Freeman, W.~J.} \& \bibinfo{author}{Zhai, J.}
\newblock \bibinfo{title}{Simulated power spectral density (psd) of background
  electrocorticogram (ecog)}.
\newblock \emph{\bibinfo{journal}{Cognitive neurodynamics}}
  \textbf{\bibinfo{volume}{3}}, \bibinfo{pages}{97--103}
  (\bibinfo{year}{2009}).

\bibitem{fukushima2015studying}
\bibinfo{author}{Fukushima, M.}, \bibinfo{author}{Chao, Z.~C.} \&
  \bibinfo{author}{Fujii, N.}
\newblock \bibinfo{title}{Studying brain functions with mesoscopic
  measurements: Advances in electrocorticography for non-human primates}.
\newblock \emph{\bibinfo{journal}{Current opinion in neurobiology}}
  \textbf{\bibinfo{volume}{32}}, \bibinfo{pages}{124--131}
  (\bibinfo{year}{2015}).

\bibitem{pmid28192130}
\bibinfo{author}{Groppe, D.~M.} \emph{et~al.}
\newblock \bibinfo{title}{{i{E}{L}{V}is: {A}n open source {M}{A}{T}{L}{A}{B}
  toolbox for localizing and visualizing human intracranial electrode data}}.
\newblock \emph{\bibinfo{journal}{J. Neurosci. Methods}}
  \textbf{\bibinfo{volume}{281}}, \bibinfo{pages}{40--48}
  (\bibinfo{year}{2017}).

\bibitem{cohen2014analyzing}
\bibinfo{author}{Cohen, M.~X.}
\newblock \emph{\bibinfo{title}{Analyzing neural time series data: theory and
  practice}} (\bibinfo{publisher}{MIT Press}, \bibinfo{year}{2014}).

\bibitem{stam2007phase}
\bibinfo{author}{Stam, C.~J.}, \bibinfo{author}{Nolte, G.} \&
  \bibinfo{author}{Daffertshofer, A.}
\newblock \bibinfo{title}{Phase lag index: assessment of functional
...
\newblock \emph{\bibinfo{journal}{Human brain mapping}}
  \textbf{\bibinfo{volume}{28}}, \bibinfo{pages}{1178--1193}
  (\bibinfo{year}{2007}).

\bibitem{nolte2004identifying}
\bibinfo{author}{Nolte, G.} \emph{et~al.}
\newblock \bibinfo{title}{Identifying true brain interaction from eeg data
  using the imaginary part of coherency}.
\newblock \emph{\bibinfo{journal}{Clinical neurophysiology}}
  \textbf{\bibinfo{volume}{115}}, \bibinfo{pages}{2292--2307}
  (\bibinfo{year}{2004}).

\bibitem{nolte2008robustly}
\bibinfo{author}{Nolte, G.} \emph{et~al.}
\newblock \bibinfo{title}{Robustly estimating the flow direction of information
  in complex physical systems}.
\newblock \emph{\bibinfo{journal}{Physical review letters}}
  \textbf{\bibinfo{volume}{100}}, \bibinfo{pages}{234101}
  (\bibinfo{year}{2008}).

\bibitem{vinck2011improved}
\bibinfo{author}{Vinck, M.}, \bibinfo{author}{Oostenveld, R.},
  \bibinfo{author}{van Wingerden, M.}, \bibinfo{author}{Battaglia, F.} \&
  \bibinfo{author}{Pennartz, C.~M.}
\newblock \bibinfo{title}{An improved index of phase-synchronization for
  electrophysiological data in the presence of volume-conduction, noise and
  sample-size bias}.
\newblock \emph{\bibinfo{journal}{Neuroimage}} \textbf{\bibinfo{volume}{55}},
  \bibinfo{pages}{1548--1565} (\bibinfo{year}{2011}).

\bibitem{peraza2012volume}
\bibinfo{author}{Peraza, L.~R.}, \bibinfo{author}{Asghar, A.~U.},
  \bibinfo{author}{Green, G.} \& \bibinfo{author}{Halliday, D.~M.}
\newblock \bibinfo{title}{Volume conduction effects in brain network inference
  from electroencephalographic recordings using phase lag index}.
\newblock \emph{\bibinfo{journal}{Journal of neuroscience methods}}
  \textbf{\bibinfo{volume}{207}}, \bibinfo{pages}{189--199}
  (\bibinfo{year}{2012}).

\bibitem{mormann2000mean}
\bibinfo{author}{Mormann, F.}, \bibinfo{author}{Lehnertz, K.},
  \bibinfo{author}{David, P.} \& \bibinfo{author}{Elger, C.~E.}
\newblock \bibinfo{title}{Mean phase coherence as a measure for phase
...
\newblock \emph{\bibinfo{journal}{Physica D: Nonlinear Phenomena}}
  \textbf{\bibinfo{volume}{144}}, \bibinfo{pages}{358--369}
  (\bibinfo{year}{2000}).

\bibitem{toppi2012statistical}
\bibinfo{author}{Toppi, J.} \emph{et~al.}
\newblock \bibinfo{title}{How the statistical validation of functional
  connectivity patterns can prevent erroneous definition of small-world
  properties of a brain connectivity network}.
\newblock \emph{\bibinfo{journal}{Computational and mathematical methods in
  medicine}} \textbf{\bibinfo{volume}{2012}} (\bibinfo{year}{2012}).

\bibitem{fallani2014graph}
\bibinfo{author}{Fallani, F. D.~V.}, \bibinfo{author}{Richiardi, J.},
  \bibinfo{author}{Chavez, M.} \& \bibinfo{author}{Achard, S.}
\newblock \bibinfo{title}{Graph analysis of functional brain networks:
  practical issues in translational neuroscience}.
\newblock \emph{\bibinfo{journal}{Phil. Trans. R. Soc. B}}
  \textbf{\bibinfo{volume}{369}}, \bibinfo{pages}{20130521}
  (\bibinfo{year}{2014}).

\bibitem{papo2014complex}
\bibinfo{author}{Papo, D.}, \bibinfo{author}{Buld{\'u}, J.~M.},
  \bibinfo{author}{Boccaletti, S.} \& \bibinfo{author}{Bullmore, E.~T.}
\newblock \bibinfo{title}{Complex network theory and the brain}
  (\bibinfo{year}{2014}).

\bibitem{munkres1984elements}
\bibinfo{author}{Munkres, J.~R.}
\newblock \emph{\bibinfo{title}{Elements of algebraic topology}},
  vol.~\bibinfo{volume}{2} (\bibinfo{publisher}{Addison-Wesley Menlo Park},
  \bibinfo{year}{1984}).

\bibitem{dabaghian2014reconceiving}
\bibinfo{author}{Dabaghian, Y.}, \bibinfo{author}{Brandt, V.~L.} \&
  \bibinfo{author}{Frank, L.~M.}
\newblock \bibinfo{title}{Reconceiving the hippocampal map as a topological
  template}.
\newblock \emph{\bibinfo{journal}{Elife}} \textbf{\bibinfo{volume}{3}},
  \bibinfo{pages}{e03476} (\bibinfo{year}{2014}).

\bibitem{dotko2016topological}
\bibinfo{author}{Dotko, P.} \emph{et~al.}
\newblock \bibinfo{title}{Topological analysis of the connectome of digital
  reconstructions of neural microcircuits}.
\newblock \emph{\bibinfo{journal}{arXiv preprint arXiv:1601.01580}}
  (\bibinfo{year}{2016}).

\bibitem{y1995histology}
\bibinfo{author}{Ram{\'o}n~y Cajal, S.}
\newblock \emph{\bibinfo{title}{Histology of the nervous system of man and
  vertebrates}}, vol.~\bibinfo{volume}{1} (\bibinfo{publisher}{Oxford
  University Press, USA}, \bibinfo{year}{1995}).

\bibitem{fornito2016fundamentals}
\bibinfo{author}{Fornito, A.}, \bibinfo{author}{Zalesky, A.} \&
  \bibinfo{author}{Bullmore, E.}
\newblock \emph{\bibinfo{title}{Fundamentals of Brain Network Analysis}}
  (\bibinfo{publisher}{Academic Press}, \bibinfo{year}{2016}).

\bibitem{stam1993quantification}
\bibinfo{author}{Stam, C.}, \bibinfo{author}{Tavy, D.} \&
  \bibinfo{author}{Keunen, R.}
\newblock \bibinfo{title}{Quantification of alpha rhythm desynchronization
  using the acceleration spectrum entropy of the eeg}.
\newblock \emph{\bibinfo{journal}{Clinical EEG and Neuroscience}}
  \textbf{\bibinfo{volume}{24}}, \bibinfo{pages}{104--109}
  (\bibinfo{year}{1993}).

\bibitem{schomer2012niedermeyer}
\bibinfo{author}{Schomer, D.~L.} \& \bibinfo{author}{Da~Silva, F.~L.}
\newblock \emph{\bibinfo{title}{Niedermeyer's electroencephalography: basic
  principles, clinical applications, and related fields}}
  (\bibinfo{publisher}{Lippincott Williams \& Wilkins}, \bibinfo{year}{2012}).
