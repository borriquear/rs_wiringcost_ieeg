...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Replace this for power based connectivity in the left and phase based (PLI) on the right. The points are the statistics we are interested in (wiring cost, or clustering etc). Do ttest non parametric s1 = clustering across threshold, plot the metrics that differentiate, wiring cost, clustering etc...first do the ttest 
\begin{figure}[ht] 
  \begin{subfigure}[t]{0.5\linewidth}
    \centering
